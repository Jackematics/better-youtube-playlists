        ...
        <>
            <div className="w-72 h-screen bg-container-dark-blue m-5 border-4 relative">
                ...
                <div className="flex items-center justify-center">
                    <button className="absolute bottom-0 left-0 w-5/6 h-11 ml-5 mb-4 rounded-lg border-2 flex bg-container-light-blue hover:bg-button-highlight-blue focus:bg-button-select-blue">
